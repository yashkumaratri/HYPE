...
from HYPE import HYPEHyperParams, apply_HYPE_to_model, GNN
...
ALG_DICT = {
    ...
    "HYPE": (HYPEHyperParams, apply_HYPE_to_model)
}
...
def main(
    ...
    for chunk in chunks(zipped_lists, num_edits):
        ...
        etc_args = dict(cache_template=cache_template) if any(
            alg in alg_name for alg in ["ROME", "MEMIT", "HYPE"]) else dict()
        HYPE_args = dict(
            graph_input=[
                graph_case['triples']
            ...
            alg in alg_name for alg in ["HYPE"]) else dict()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--alg_name",
        choices=["MEMIT", "ROME", "FT", "MEND", "HYPE"],
        default="HYPE",
